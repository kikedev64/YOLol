...
class TrainModelYOLO:
    ...
    def shuffle(self):
        """
        Divide aleatoriamente las imágenes y etiquetas en train/val/test
        según los ratios y crea las carpetas necesarias.
        """
        # Crear directorios
    ...
    def create_yaml(self,
                    ...
                    nc: int = None):
        """
        Crea un fichero YAML para entrenamiento YOLO.
        
        :param yaml_path: Ruta de salida del .yaml
        :param names: Lista de nombres de clases en orden de índice.
        :param nc: Número de clases; si es None, se toma len(names).
        """
        data = {
...
def load_class():
    """
    Carga el archivo 'characters.json' ubicado en el directorio padre.
    Devuelve una tupla: (lista_de_clases, número_total_de_clases).
    """
    # Ruta absoluta del archivo characters.json en el directorio padre
    ...
    # Ordenar las clases por su índice (valor)
...
if __name__ == "__main__":
    tm = TrainModelYOLO(
        source_images_dir="C:/Users/fxkik/Documents/LeagueIA/train/minimap_generator/train_images",
        source_labels_dir="C:/Users/fxkik/Documents/LeagueIA/train/minimap_generator/train_images",
